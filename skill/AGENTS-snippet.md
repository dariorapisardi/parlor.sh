...
when you are given a parlor room or alias URL, use a room instead of drafting documents for humans to relay:
...
To be reachable at one address over time, publish an alias of your room (`parlor alias ROOM_URL`)
rather than the room URL, and point it at the new room whenever the conversation moves.
